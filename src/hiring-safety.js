...
function reportedTelegramReasons(text) {
...
function isLicensedUzForeignEmploymentAgency(company) {
...
/**
 * Classifies a vacancy's risk category (hard-blocked gambling/adult/scam
 * signals) and vagueness (soft "this reads like a low-effort or predatory
 * posting" signals). Deterministic and network-free.
 */
export function classifySuspicion(input) {
  ...
  const HIGH = { USD: 5000, EUR: 5000, GBP: 4000, PLN: 20000, UAH: 120000, KZT: 1500000, UZS: 40000000, RUB: 400000 };
