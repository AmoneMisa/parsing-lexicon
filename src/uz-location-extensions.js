...
export const UZ_LOCATION_EXTENSIONS = Object.freeze({
  Tashkent: city({
    mahallas: [
      ...
      { name: 'Qalqon', aliases: ['Қалқон','Калкон'], parent: 'Yashnobod', confidence: 'official' },
      { name: "Bog'bon", aliases: ['Bog‘bon','Bogʻbon','Bogbon','Боғбон','Богбон'], parent: 'Yashnobod', confidence: 'official' },
    ...
    localAreas: [
      ...
      { name: 'Suvsoz-1', aliases: ['Suvsoz 1','Suvsoz-1 mavzesi','Сувсоз-1','Сувсоз 1','Водник-1','Водник 1'], parent: 'Bektemir', confidence: 'official' },
      { name: 'Suvsoz-2', aliases: ['Suvsoz 2','Suvsoz-2 mavzesi','Сувсоз-2','Сувсоз 2','Водник-2','Водник 2'], parent: 'Bektemir', confidence: 'official' },
      { name: 'Suvsoz-3', aliases: ['Suvsoz 3','Suvsoz-3 mavzesi','Сувсоз-3','Сувсоз 3','Водник-3','Водник 3'], parent: 'Bektemir', confidence: 'official' },
      { name: 'Suvsoz-4', aliases: ['Suvsoz 4','Suvsoz-4 mavzesi','Сувсоз-4','Сувсоз 4'], parent: 'Bektemir', confidence: 'official' },
      { name: 'Suvsoz-5', aliases: ['Suvsoz 5','Suvsoz-5 mavzesi','Сувсоз-5','Сувсоз 5'], parent: 'Bektemir', confidence: 'official' },
      ...
      { name: "Qo'yliq-1", aliases: ['Qo‘yliq-1','Qoʻyliq-1','Qoyliq-1','Qoyliq 1','Куйлюк-1','Куйлюк 1','Куйлик-1','Куйлик 1'], parent: 'Mirobod', confidence: 'official' },
      { name: "Qo'yliq-2", aliases: ['Qo‘yliq-2','Qoʻyliq-2','Qoyliq-2','Qoyliq 2','Куйлюк-2','Куйлюк 2','Куйлик-2','Куйлик 2'], parent: 'Mirobod', confidence: 'official' },
      { name: "Qo'yliq-3", aliases: ['Qo‘yliq-3','Qoʻyliq-3','Qoyliq-3','Qoyliq 3','Куйлюк-3','Куйлюк 3','Куйлик-3','Куйлик 3'], parent: 'Mirobod', confidence: 'official' },
      { name: "Qo'yliq-4", aliases: ['Qo‘yliq-4','Qoʻyliq-4','Qoyliq-4','Qoyliq 4','Куйлюк-4','Куйлюк 4','Куйлик-4','Куйлик 4'], parent: 'Mirobod', confidence: 'official' },
      { name: "Qo'yliq-5", aliases: ['Qo‘yliq-5','Qoʻyliq-5','Qoyliq-5','Qoyliq 5','Куйлюк-5','Куйлюк 5','Куйлик-5','Куйлик 5'], parent: 'Sergeli', confidence: 'official' },
      { name: "Qo'yliq-6", aliases: ['Qo‘yliq-6','Qoʻyliq-6','Qoyliq-6','Qoyliq 6','Куйлюк-6','Куйлюк 6','Куйлик-6','Куйлик 6'], parent: 'Sergeli', confidence: 'official' },
      { name: "Qo'yliq-7", aliases: ['Qo‘yliq-7','Qoʻyliq-7','Qoyliq-7','Qoyliq 7','Куйлюк-7','Куйлюк 7','Куйлик-7','Куйлик 7'], parent: 'Sergeli', confidence: 'official' },
      { name: 'Parkent-Riyoziy', aliases: ['Parkent Riyoziy','Riyoziy','Mavlono Riyoziy','Мавлоно Риёзи','Риёзий','Риезий','Паркент Риёзий'], parent: 'Yashnobod', confidence: 'official' },
      { name: 'Parkent-Siolkovskiy', aliases: ['Parkent Siolkovskiy','Parkent Tsiolkovskiy','Сиолковский массив','Циолковский массив','Паркент Сиолковский'], parent: 'Yashnobod', confidence: 'official' },
      { name: 'Qalqon', aliases: ['Qalqon mavzesi','Қалқон мавзе','Калкон массив','Harbiylar-58a','Harbiylar 58a','Harbiylar-58a shaharchasi'], parent: 'Yashnobod', confidence: 'official' },
      { name: "Bog'bon", aliases: ['Bog‘bon mavzesi','Bogʻbon mavzesi','Bogbon mavzesi','Боғбон мавзе','Богбон массив','Normuhammedov mavzesi','Normuhammedov','Нормухаммедов'], parent: 'Yashnobod', confidence: 'official' },
      ...
      { name: 'Guruchariq', aliases: ['Guruchariq mavzesi','Guruch ariq','Гуручариқ','Гуручарик','S-22','S 22','С-22','С 22','C-22','C 22'], parent: 'Almazar', confidence: 'official' },
      ...
      { name: 'Beruniy-B1', aliases: ['Beruniy B1','Beruniy B-1','Беруний-Б1','Беруний Б1'], parent: 'Almazar', confidence: 'official' },
      { name: 'Beruniy-B3', aliases: ['Beruniy B3','Beruniy B-3','Беруний-Б3','Беруний Б3'], parent: 'Almazar', confidence: 'official' },
      ...
      { name: "Sug'diyona", aliases: ['Sug‘diyona mavzesi','Sugʻdiyona mavzesi','Sugdiyona mavzesi','Суғдиёна мавзе','Согдиана массив'], parent: 'Sergeli', confidence: 'official' },
    ],
    developmentAreas: [
  ...
  Samarkand: city({
    ...
    landmarks: [
      ...
      ['Siyob Bazaar','Сиабский базар','Siyob bozori','Сиёб бозори'],['Afrosiyob','Афросиёб'],['Ulugbek Observatory','Обсерватория Улугбека',"Ulug'bek rasadxonasi"],['University Boulevard','Университетский бульвар','Universitet xiyoboni'],
