...
export const ADDRESS_TERMS = Object.freeze({
  ...
  landmark: group('landmark', {
    ru: ['ориентир', 'ор-р', 'орр', 'рядом с', 'возле', 'напротив'], en: ['landmark', 'near', 'next to', 'opposite'], uk: ['орієнтир', 'поруч', 'біля', 'навпроти'], ro: ['reper', 'lângă', 'langa', 'în apropiere', 'in apropiere', 'vizavi'],
...
export const HOUSING_OCCUPANCY_TYPES = Object.freeze([
  ...
  group('sharedRoom', {
    ...
    uzLatn: ['sherik kerak', 'sherik olaman', 'xonaga sherik', 'birga turishga', 'qiz olinadi', 'yigit olinadi', 'podseleniye'], uzCyrl: ['шерик керак', 'хонага шерик', 'бирга туришга', 'қиз олинади', 'йигит олинади'], kk: ['бірге тұруға', 'бөлмелес керек', 'көрші керек', 'ортақ бөлме'],
  }),
  group('bedSpace', {
...
export const APPLIANCE_TERMS = Object.freeze({
  ...
  television: group('television', { ru: ['телевизор', 'тв'], en: ['television', 'tv'], uk: ['телевізор', 'тв'], ro: ['televizor', 'tv'], uzLatn: ['televizor', 'telivizor', 'tv'], uzCyrl: ['телевизор'], kk: ['теледидар'] }),
  airConditioner: group('airConditioner', { ru: ['кондиционер', 'сплит система'], en: ['air conditioner', 'air conditioning', 'ac'], uk: ['кондиціонер'], ro: ['aer condiționat', 'aer conditionat', 'climă', 'clima'], uzLatn: ['konditsioner', 'kandisaner'], uzCyrl: ['кондиционер'], kk: ['кондиционер'] }),
