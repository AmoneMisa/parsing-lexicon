...
export const HIRING_NON_CONTENT_TERMS = Object.freeze([
  ...
  group('jobService', { ru: ['помогу найти работу', 'подбор вакансий', 'сервис поиска работы', 'каналы с вакансиями', 'выбирай свою сферу и подписывайся'], en: ['job search service', 'we help you find a job'], uk: ['допоможемо знайти роботу'], ro: ['serviciu de căutare job'], uzLatn: ['ish topishga yordam'], uzCyrl: ['иш топишга ёрдам'], kk: ['жұмыс табуға көмектесеміз'] }),
