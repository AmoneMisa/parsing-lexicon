...
export const UA_REGIONAL_LOCATION_EXTENSIONS = Object.freeze({
  ...
  Chernivtsi: city({
    microdistricts: [
      ['Tsentr','Центр'],['Prospekt','Проспект'],['Komarova','Комарова'],['Pivdenno-Kiltseva','Південно-Кільцева','Южно-Кольцевая'],['Hraviton','Гравітон','Гравитон'],['Kalichanka','Калічанка','Каличанка'],['Sadgora','Садгора','Садгірський','Садгірський район','Садгорский','Садгорский район','Sadhora'],['Roscha','Роша'],['Klokuchka','Клокучка'],['Roscha-Stynka','Роша-Стинка'],['Tsetsyno','Цецино'],['Lenkivtsi','Ленківці','Ленковцы'],['Fastivska','Фастівська'],['Rohizna','Рогізна','Рогозна','Rohozna','Rogozna'],['Stara Zhuchka','Стара Жучка','Старая Жучка'],['Nova Zhuchka','Нова Жучка','Новая Жучка'],['Sadky','Садки'],['Pentagon','Пентагон'],['Mashzavod','Машзавод'],['Pivdennyi Masyv','Південний масив','Южный массив'],['Horecha','Гореча'],['Stare Misto','Старе Місто','Старе місто','Старый город'],
    ],
    residentialComplexes: [
    ...
    landmarks: [
      ['Metropolitan Residence','Резиденція митрополитів','Резиденция митрополитов'],['Chernivtsi University','ЧНУ','університет Федьковича','Чернівецький університет','Черновицкий университет','Чернівецький національний університет','Черновицкий национальный университет'],['Teatralna Square','Театральна площа','Театральная площадь'],['Central Square','Центральна площа','Центральная площадь'],['Turkish Square','Турецька площа','Турецька криниця','Турецкая площадь','Турецкий колодец'],['Kobylianska Street','Ольги Кобилянської','вулиця Кобилянської','вулиця Ольги Кобилянської','улица Ольги Кобылянской','Кобилянська','Кобылянская'],['Shevchenko Park','парк Шевченка','парк Шевченко'],['Botanical Garden','Ботанічний сад','Ботанический сад'],['City Hall','Ратуша','Чернівецька ратуша','Черновицкая ратуша'],['Chernivtsi Railway Station','Чернівецький залізничний вокзал','залізничний вокзал Чернівці','вокзал Чернівці','железнодорожный вокзал Черновцы','вокзал Черновцы'],['Chernivtsi International Airport','Міжнародний аеропорт Чернівці','Міжнародний аеропорт «Чернівці»','аеропорт Чернівці','Международный аэропорт Черновцы','аэропорт Черновцы'],['Central Bus Station','Центральний автовокзал','автовокзал Чернівці','Центральный автовокзал','автовокзал Черновцы'],['Kalynivskyi Market','Калинівський ринок','Калиновский рынок'],['Zhovtnevyi Park','Парк Жовтневий','парк Жовтневий','Жовтневий парк','Октябрьский парк','парк Октябрьский','Reformation Park','Парк Реформації','Парк Реформации'],['Kobylianska Drama Theatre','театр Кобилянської','театр Кобылянской','Музично-драматичний театр імені Ольги Кобилянської','Музыкально-драматический театр имени Ольги Кобылянской'],['Bukovyna Mall','ТРЦ Bukovyna Mall','Буковина Молл','Буковина Mall'],["DEPO't Center","ТРЦ DEPO't Center",'DEPOt Center','Depot Center','ТРЦ Депот'],['Prospekt Shopping Center','ТЦ Проспект','ТРЦ Проспект','торговий центр Проспект','торговый центр Проспект'],['Formarket Shopping Center','ТЦ Формаркет','ТРЦ Формаркет','Формаркет'],['Maidan Shopping Center','ТЦ Майдан','ТРЦ Майдан','Майдан ТЦ'],['Millennium Shopping Center','ТЦ Міленіум','ТРЦ Міленіум','Міленіум','ТЦ Миллениум','ТРЦ Миллениум','Миллениум'],
    ],
  }),
