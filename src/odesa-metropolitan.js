...
export const ODESA_RIVIERA_ENTITIES = Object.freeze([
  entity('ТРЦ Рів’єра', 'poi.shopping_mall', ['Ривьера','Рів’єра','Riviera','ТРЦ Ривьера','ТРЦ Рів’єра','Riviera Shopping City','Riviera Mall','ТЦ Ривьера','ТЦ Рів’єра'], { cluster: NORTH_EAST_CLUSTER, parent: 'Фонтанка', contextRequired: true, context: MALL_CONTEXT }),
