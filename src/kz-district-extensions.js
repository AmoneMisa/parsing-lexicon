...
export const KZ_DISTRICT_EXTENSIONS = Object.freeze({
  Shymkent: city([
    ['Abai', 'Абай', 'Абай ауданы', 'Абайский район', 'район Абай', 'Абайском районе'],
    ['Al-Farabi', 'Әл-Фараби', 'Әл-Фараби ауданы', 'Аль-Фарабийский район', 'Аль-Фараби район', 'Аль-Фарабийском районе'],
    ['Enbekshi', 'Еңбекші', 'Еңбекші ауданы', 'Енбекшинский район', 'район Енбекши', 'Енбекшинском районе'],
    ['Karatau', 'Қаратау', 'Қаратау ауданы', 'Каратауский район', 'район Каратау', 'Каратауском районе'],
    ['Turan', 'Тұран', 'Тұран ауданы', 'Туранский район', 'район Туран', 'Туранском районе'],
  ]),
  Karaganda: city([
