...
export const PROPERTY_CONDITION_TERMS = Object.freeze([
  ...
  group('euroRenovation', { ru: ['евроремонт'], en: ['euro renovation', 'euro-renovated'], uk: ['євроремонт'], ro: ['renovare euro'], uzLatn: ['evroremont', 'evro remont', 'yevro remont'], uzCyrl: ['евроремонт'], kk: ['евроремонт'] }),
  ...
  group('needsRenovation', { ru: ['требует ремонта', 'под ремонт', 'нужен ремонт'], en: ['needs renovation', 'requires renovation'], uk: ['потребує ремонту', 'під ремонт'], ro: ['necesită renovare'], uzLatn: ['remont kerak', "ta'mirsiz", 'tamirsiz', "ta'mirga muhtoj"], uzCyrl: ['ремонт керак', 'таъмирсиз', 'тамирсиз'], kk: ['жөндеу қажет'] }),
