...
export const KG_CITIES = Object.freeze([
  ...
  entity('Bazar-Korgon', { ky: ['Базар-Коргон'], ru: ['Базар-Коргон', 'Базар Коргон'], en: ['Bazar-Korgon', 'Bazar Korgon'] }, { country: 'KG', type: 'city' }),
  entity('Cholpon-Ata', { ky: ['Чолпон-Ата', 'Чолпон Ата'], ru: ['Чолпон-Ата', 'Чолпон Ата'], en: ['Cholpon-Ata', 'Cholpon Ata'] }, { country: 'KG', type: 'city' }),
  entity('Gulcho', { ky: ['Гүлчө', 'Гульчо'], ru: ['Гульча', 'Гулча'], en: ['Gulcho', 'Gulcha'] }, { country: 'KG', type: 'city' }),
  entity('Kadamjay', { ky: ['Кадамжай'], ru: ['Кадамжай', 'Фрунзе'], en: ['Kadamjay', 'Kadamzhai', 'Frunze'] }, { country: 'KG', type: 'city' }),
  entity('Kara-Kol', { ky: ['Кара-Көл', 'Кара Кол'], ru: ['Кара-Куль', 'Кара-Куль'], en: ['Kara-Kol', 'Kara-Kul'] }, { country: 'KG', type: 'city' }),
  entity('Kara-Suu', { ky: ['Кара-Суу', 'Кара Суу'], ru: ['Кара-Суу', 'Кара Суу'], en: ['Kara-Suu', 'Kara Suu'] }, { country: 'KG', type: 'city' }),
  entity('Kayyngdy', { ky: ['Кайыңды', 'Кайынды'], ru: ['Каинды'], en: ['Kayyngdy', 'Kayindy', 'Kainy'] }, { country: 'KG', type: 'city' }),
  entity('Kemin', { ky: ['Кемин'], ru: ['Кемин', 'Быстровка'], en: ['Kemin', 'Bystrovka'] }, { country: 'KG', type: 'city' }),
  entity('Kerben', { ky: ['Кербен'], ru: ['Кербен', 'Караван'], en: ['Kerben', 'Karavan'] }, { country: 'KG', type: 'city' }),
  entity('Kochkor-Ata', { ky: ['Кочкор-Ата', 'Кочкор Ата'], ru: ['Кочкор-Ата', 'Кочкор Ата'], en: ['Kochkor-Ata', 'Kochkor Ata'] }, { country: 'KG', type: 'city' }),
  entity('Kok-Janggak', { ky: ['Көк-Жаңгак', 'Көк Жаңгак'], ru: ['Кок-Янгак', 'Кок Янгак'], en: ['Kok-Janggak', 'Kok-Jangak', 'Kok Yangak'] }, { country: 'KG', type: 'city' }),
  entity('Mayluu-Suu', { ky: ['Майлуу-Суу', 'Майлуу Суу'], ru: ['Майлуу-Суу', 'Майли-Сай'], en: ['Mayluu-Suu', 'Mailuu-Suu', 'Mayli-Sai'] }, { country: 'KG', type: 'city' }),
  entity('Nookat', { ky: ['Ноокат'], ru: ['Ноокат', 'Эски-Ноокат'], en: ['Nookat', 'Eski-Nookat'] }, { country: 'KG', type: 'city' }),
  entity('Orlovka', { ky: ['Орловка'], ru: ['Орловка'], en: ['Orlovka'] }, { country: 'KG', type: 'city' }),
  entity('Razzakov', { ky: ['Раззаков'], ru: ['Раззаков', 'Исфана'], en: ['Razzakov', 'Isfana'] }, { country: 'KG', type: 'city' }),
  entity('Shopokov', { ky: ['Шопоков'], ru: ['Шопоков', 'Новотроицкое', 'Краснооктябрьский'], en: ['Shopokov', 'Novotroitskoye'] }, { country: 'KG', type: 'city' }),
  entity('Suluktu', { ky: ['Сүлүктү', 'Сулюкту'], ru: ['Сулюкта'], en: ['Suluktu', 'Sulyukta'] }, { country: 'KG', type: 'city' }),
  entity('Tash-Kumur', { ky: ['Таш-Көмүр', 'Таш Көмүр'], ru: ['Таш-Кумыр', 'Таш Кумыр'], en: ['Tash-Kumur', 'Tash-Kumyr'] }, { country: 'KG', type: 'city' }),
  entity('Toktogul', { ky: ['Токтогул'], ru: ['Токтогул'], en: ['Toktogul'] }, { country: 'KG', type: 'city' }),
]);
