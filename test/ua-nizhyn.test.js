...
test('Nizhyn dictionary contains geo-aligned landmark canonicals', () => {
  ...
  assert.ok(names.has('Свято-Миколаївський кафедральний собор'));
});
...
test('Nizhyn landmark aliases resolve to expected canonicals', () => {
  const cases = [
    ...
    ['Миколаївський кафедральний собор (Ніжин)', 'Свято-Миколаївський кафедральний собор'],
    ['Миколаївський собор', 'Свято-Миколаївський кафедральний собор'],
    ['Собор Святого Миколая Чудотворця', 'Свято-Миколаївський кафедральний собор'],
  ];
